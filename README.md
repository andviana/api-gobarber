...
- O uuário deve poder recuperar sua senha informando seu e-mail;
- O usuário deve receber um e-mail copm instruções de recuperação de senha;
...
- O usuário deve poder listar horarios disponíveis em um dua específico de um prestador;
